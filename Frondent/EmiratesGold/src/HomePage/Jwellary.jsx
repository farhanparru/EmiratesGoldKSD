...
const Jewelry = () => {
  ...
  return (
    <div className="py-10 bg-gray-50">
      <div className="max-w-6xl mx-auto flex flex-col gap-16 px-4 lg:px-0">
      
        {/* Section 1: Polished Diamonds */}
        <div data-aos="flip-right" className="flex flex-col lg:flex-row items-center gap-8 lg:ml-10 lg:ml-0 lg:pl-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h2 className="text-2xl lg:text-3xl font-semibold text-gray-800 mb-4">Polished Diamonds</h2>
        ...
        {/* Section 2: Diamond Jewellery */}
        <div data-aos="flip-up" className="flex flex-col lg:flex-row items-center gap-8 lg:mr-10 lg:mr-0 lg:pr-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left order-last lg:order-first">
            <h2 className="text-2xl lg:text-3xl font-semibold text-gray-800 mb-4">Diamond Jewellery</h2>
            <p className="text-gray-600 leading-relaxed mb-4 text-sm lg:text-base">
